function consultarCategoria(dato, callback){
  return $.ajax({
      type: "GET",
      url: $("#urlCPQ").val() + "/rest/v6/customDT_MODELO?q={'cod_modelo':"+dato+"}",
      data: {},
  ...
  return  $.ajax({
        type: "GET",
        url: $("#urlCPQ").val() + "/rest/v6/customDT_RELAC_PROD?q={modelo:'"+dato+"'}",
        data: {},
        contentType: "application/json",
        dataType: "json",
        success: function (result) {
  ...
  return $.ajax({
      type: "POST",
      url: $("#UrlOIC").val() + "/ic/api/integration/v1/flows/rest/FLOW_GET_DISPONIBIL/2.0/",
      contentType: "application/json",
  ...
  return $.ajax({
        type: "GET",
        url: $("#urlCPQ").val() + "/rest/v6/customDT_RELAC_PROD?q={modelo:'" + modelo +"', centro: '" + centro + "', canal_dist:'" + canal + "', org_venda:'" + org + "'}",
        data: {},
        contentType: "application/json",
        dataType: "json",
        success: function (result) {
